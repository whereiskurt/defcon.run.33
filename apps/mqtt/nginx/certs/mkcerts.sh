...
openssl req -new -newkey rsa:2048 -nodes -keyout nginx-selfsigned.key -out nginx-selfsigned.csr -subj "/C=US/ST=Nevada/L=LasVegas/O=defcon.run/OU=Engineering/CN=mqtt.defcon.run"
