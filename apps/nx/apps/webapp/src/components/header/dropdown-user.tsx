...
import { Avatar, Button, Dropdown, DropdownItem, DropdownMenu, DropdownSection, DropdownTrigger, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, User, useDisclosure } from "@heroui/react";
          ...
          <DropdownSection aria-label="Profile & Actions" showDivider>
            ...
            {!session.user.hasStrava ?
              <DropdownItem
                ...
                textValue="Link to Strava" key="strava"
              >
                Link to Strava
              </DropdownItem> : <DropdownItem key="a" className="h-0 invisible" textValue="Already Strava'd" />}
