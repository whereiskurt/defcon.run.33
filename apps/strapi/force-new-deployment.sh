...
export STRAPI=${STRAPI:-"strapi-defcon-run"}

LATEST_STRAPI=$(aws ecs list-task-definitions --family-prefix $STRAPI --sort DESC --query "taskDefinitionArns[0]" --output text)
